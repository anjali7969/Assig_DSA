...
public class  AntColonyAlgorithm_a {
    ...
    public AntColonyAlgorithm_a(double[][] distances, int numAnts, double decay, double alpha, double beta) {
    ...
    public static void main(String[] args) {
        ...
        AntColonyAlgorithm_a antColony = new AntColonyAlgorithm_a(distances, numAnts, decay, alpha, beta);
